...
const useCartEffect = (shopId) => {
  ...
  return { cartList, changeCartItemChecked, cleanCartProduct, setCartItemCheck, showCartList, handleShowCartlist }
}
export default {
  name: 'Cart',
  setup () {
    ...
    const { cartList, changeCartItemChecked, cleanCartProduct, setCartItemCheck, showCartList, handleShowCartlist } = useCartEffect(shopId)
    const { changeCartItemInfo, computedCart, productList } = useCommonCartEffect(shopId)
    return {
      cartList,
      computedCart,
      productList,
